...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateButton.innerHTML = '<i data-feather="refresh-cw"></i> Update from ClinicalTrials.gov';
    ...
    function displayTrials(trialsToShow) {
        ...
        trialsToShow.forEach(trial => {
            ...
            toggleButton.innerHTML = '<i data-feather="chevron-down"></i> Look criteria';
            ...
            toggleButton.addEventListener('click', function() {
                ...
                if (isExpanded) {
                    // Nascondi i criteri
                    criteriaContainer.style.display = 'none';
                    this.innerHTML = '<i data-feather="chevron-down"></i> Look criteria';
